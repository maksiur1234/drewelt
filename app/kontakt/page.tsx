  ...
  return (
    <div className="flex flex-col items-start space-y-6 p-6">
      <div className="flex w-full justify-between">
        <div className="pr-12"><p className="text-xl font-bold">Skontaktuj się z nami, </p>pomożemy Ci dobrać najlepszą opcję!</div>
      ...
      <div className="mx-auto flex flex-col items-center w-full max-w-4xl px-4">
        <Card
          fullWidth
          className="w-full max-w-3xl shadow-lg p-6"
        >
          <CardBody>
            <Form
