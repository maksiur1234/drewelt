  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.cardText}>Często zwężenie lub poszerzenie wiaty o zaledwie 10-15 cm pozwala idealnie wpasować się w arkusz płyty. Zyskujesz tę samą swobodę otwierania drzwi, a oszczędzasz nawet 2000 zł. <strong>Zapytaj o to przy pomiarze.</strong></p>
      </div>

      <p className={styles.cardTitle__drugi}>Najkorzystniejsze cenowo wymiar</p>

      <div className={styles.card}>
            <p className={styles.cardText}>📏 Długość (po ścianie): 422 / 530 / 634 / 740 / 846 cm</p>
            <p className={styles.cardText}>📏 Szerokość/głębokość: 290 / 340 / 450 / 500 / 600 cm</p>
      </div>
    </div>
  )
}
